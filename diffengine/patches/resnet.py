...
class ResnetBlock2D(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.norm1 = GroupNorm(num_groups=groups, num_channels=in_channels, eps=eps, affine=True, act="silu")
        ...
        self.norm2 = GroupNorm(num_groups=groups_out, num_channels=out_channels, eps=eps, affine=True, act="silu" if self.time_embedding_norm != "scale_shift" else "")
